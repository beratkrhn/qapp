...
enum Theme {
    ...
    // MARK: - Tajweed Colors (Turkish Tajweed rule set — exact hex values)

    /// Deep pink — İdgham Meal Günne + Bila Günne (a/w/n/g)
    ...
    /// Rose — Medd-i Muttasıl + Medd-i Munfasıl (k/t)
    static let tajweedMaddQasr      = Color(hex: "be4b58")
    /// Dark red — Medd-i Lazım (u)
    static let tajweedMaddLazim     = Color(hex: "9b4c3a")
    /// Bright blue — Medd-i Arız / Tabii / Sıla / Zamir (j/r/v/x)
